...
out_one_D <- one_D_Mapper(Ds_for_an,filter_function,n_int = 10,p = 0.3,distance_type = "cor",clust_type = "PAM",linkage_type = "complete",optimal_clust_mode =  "standard",n_bins_clust = 10)
warnings()
